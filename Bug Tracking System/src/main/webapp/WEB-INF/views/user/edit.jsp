...
<h4 align="center">
	<spring:message code="label.userupdate.title" />
</h4>
<form:form name="myForm" method="post" action="${user.userId}"
	commandName="user">
	<table>
		<tr>
		...
		<tr>
			...
			<td><form:input type="password" onclick="this.value=''"
					path="password" /></td>
	...
	<div class=row>
		<div class="span6" align="left">
			<input type="button"  class="btn btn-warning"
				onclick="location.href='<c:url value="/user/sort=${column}-${direction}/page=${page}&limit=${recordsLimit}"/>'"
				value="<spring:message code="label.cancel" />" />
			<%String state = (String) request.getSession().getAttribute("success");
	 		if (state == null) {
	 			state = "1";
	 		}
	 		if (state.equals("false"))
	 			...
	 			&nbsp;&nbsp; 
	 			<font color="blue"> 
	 				<spring:message code="label.user.notcreated" />
	 			</font> 
